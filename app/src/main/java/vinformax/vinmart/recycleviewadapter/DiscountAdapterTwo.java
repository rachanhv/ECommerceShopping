 ...
 */
public class DiscountAdapterTwo extends RecyclerView.Adapter<DiscountAdapterTwo.PersonViewHolder> {
    ...
    public DiscountAdapterTwo(List<AssignVariable> assignVariables){
        this.assignVariables = assignVariables;
    }

    @Override
    public DiscountAdapterTwo.PersonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(DiscountAdapterTwo.PersonViewHolder holder, int i) {
