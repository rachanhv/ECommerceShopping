 ...
 * Created by Mobtech-05 on 8/10/2016.
 */
public class DiscountAdapterFour extends RecyclerView.Adapter<DiscountAdapterFour.PersonViewHolderFour> {
    ...
    public DiscountAdapterFour(List<AssignVariable> assignVariables){
        this.assignVariables = assignVariables;
    }
    @Override
    public PersonViewHolderFour onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_adapter, parent, false);
        PersonViewHolderFour pvh = new PersonViewHolderFour(v);
        return pvh;
    }

    @Override
    public void onBindViewHolder(DiscountAdapterFour.PersonViewHolderFour holder, int i) {
    ...
    public class PersonViewHolderFour extends RecyclerView.ViewHolder  implements View.OnClickListener{
        CardView cv;
        ...
        PersonViewHolderFour(View itemView) {
            super(itemView);
